    ...
    <div class="right-section">
      ...
      <el-form :model="user" :rules="rules" ref="registerRef" class="login-form">
        ...
        <el-form-item prop="confirmPass">
          <el-input prefix-icon="el-icon-lock" size="medium" show-password placeholder="请确认密码" v-model="user.confirmPass" @focus="handlePasswordFocus" @blur="handlePasswordBlur"></el-input>
        </el-form-item>
        <el-form-item prop="role">
          <el-select v-model="user.role" size="medium" placeholder="请选择角色" style="width: 100%" @focus="handleRoleFocus" @blur="handleRoleBlur">
